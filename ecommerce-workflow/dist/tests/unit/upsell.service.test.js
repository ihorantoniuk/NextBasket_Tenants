...
const upsell_service_1 = require("../../src/services/upsell.service");
...
describe('UpsellService', () => {
    let upsellService;
    beforeEach(() => {
        upsellService = new upsell_service_1.UpsellService();
        jest.clearAllMocks();
    });
    describe('generateUpsellSuggestions', () => {
        ...
        it('should generate upsell suggestions successfully', async () => {
            ...
            mockedAxios.post.mockImplementation(() => new Promise(resolve => setTimeout(() => resolve(aiResponse), 10)));
...
//# sourceMappingURL=upsell.service.test.js.map